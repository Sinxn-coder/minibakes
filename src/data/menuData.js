...
export const menuData = [
  {
    ...
    items: [
      ...
      { id: 'c-3d', name: '3D Custom Cake Designer', price: 'WA', isFullWidth: true, images: [...roundImages, ...heartImages], description: 'Design your own cake in 3D! Choose layers, shapes, and decorations to see your masterpiece come to life.' },
    ]
  },
  {
    category: "Cupcakes",
  ...
  },
  {
    ...
    items: [
      { id: 't2', name: 'Breakable Heart Box', price: '€37', img: heart1, images: [heart1], description: 'Heart made of White Chocolate filled with marshmallows & chopsticks. Includes 8 cakesicles.' },
    ]
  },
  {
    category: "Mini Cakes",
    items: [
      { id: 'mc1', name: 'Mini Cake (Small)', price: '€3.50', img: mini2, images: [mini2, mini1], description: 'Bite-sized indulgence (Single portion). Choice of Chocolate, Vanilla, or Red Velvet flavors. Choice of 1 signature spread.' },
      { id: 'mc2', name: 'Mini Cake (Large)', price: '€5.50', img: mini1, images: [mini1, mini2], description: 'A delightful small treat (Large portion). Choice of Chocolate, Vanilla, or Red Velvet flavors. Choice of 1 signature spread.' },
    ]
  },
  {
    category: "Cakesicles",
