...
export const menuData = [
  {
    ...
    items: [
      ...
      { id: 'c-3d', name: '3D Custom Cake Designer', price: 'Price via WhatsApp', isFullWidth: true, description: 'Design your own cake in 3D! Choose layers, shapes, and decorations to see your masterpiece come to life.' },
    ]
  },
  {
    category: "Cupcakes",
